...
public class SimpleMonthView extends View {
    ...
    private void drawMonthDayLabels(Canvas canvas) {
        ...
        for (int i = 0; i < mNumDays; i++) {
            ...
            if (numberDay.contains("日")) {
                numberDay = "周日";
            } else if (numberDay.contains("一")) {
                numberDay = "周一";
            } else if (numberDay.contains("二")) {
                numberDay = "周二";
            } else if (numberDay.contains("三")) {
                numberDay = "周三";
            } else if (numberDay.contains("四")) {
                numberDay = "周四";
            } else if (numberDay.contains("五")) {
                numberDay = "周五";
            } else if (numberDay.contains("六")) {
                numberDay = "周六";
            }
