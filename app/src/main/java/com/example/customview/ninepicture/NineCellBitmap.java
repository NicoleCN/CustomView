...
/***
 *@date 创建时间 2019/9/5 9:35
 *@author 作者: BoXun.Zhao
 *@description 将图片聚合成9宫格
 *             本地路径和网络路径
 */
public class NineCellBitmap<T extends String> {
    private Builder builder;

    private NineCellBitmap(Builder builder) {
    ...
    public <T> void collectBitmap(final Context context, final List<T> dataList, final BitmapCallBack callBack) {
        Observable.create(new ObservableOnSubscribe() {
            ...
            public Bitmap apply(T ts) throws Exception {
                return changeRes2Bitmap(context, (String) ts);
            }
    ...
    public static class Builder {
        ...
        public NineCellBitmap build() {
            return new NineCellBitmap(this);
        }
    ...
    private Bitmap changeRes2Bitmap(Context context, String url) {
        Bitmap bitmap = null;
        try {
